    ...
    return (
        <div className="min-h-screen bg-linear-to-br from-slate-950 to-slate-900  text-white">
            <section className="flex flex-col items-center justify-center text-center px-6 py-28 relative overflow-hidden">
                ...
                <h1
                    className="text-4xl md:text-5xl font-extrabold tracking-tight text-white my-6
"
                >
                ...
                <p className="max-w-2xl text-gray-400 text-lg md:text-xl leading-relaxed mb-6">
                    Stop searching and start finding. Browse thousands of products with a seamless interface designed to make your checkout as fast as
                    a single click.
                </p>
            ...
            <section className="py-24 px-8">
                <h2 className="text-3xl font-bold text-center mb-16 text-gray-200">Why Choose Us?</h2>
                ...
                <div className="grid md:grid-cols-3 gap-10 max-w-6xl mx-auto">
                    <div className="bg-slate-900/60 backdrop-blur-md border border-slate-800 p-8 rounded-2xl hover:border-purple-500 transition">
                        <h3 className="text-xl font-semibold mb-3 text-purple-400">Fast Delivery</h3>
                        <p className="text-gray-400 text-lg">Optimized logistics system ensures lightning speed shipping.</p>
                    </div>
                    ...
                    <div className="bg-slate-900/60 backdrop-blur-md border border-slate-800 p-8 rounded-2xl hover:border-indigo-500 transition">
                        <h3 className="text-xl font-semibold mb-3 text-indigo-400">Secure Payments</h3>
                        <p className="text-gray-400 text-lg">End-to-end encrypted checkout for total peace of mind.</p>
                    </div>

                    <div className="bg-slate-900/60 backdrop-blur-md border border-slate-800 p-8 rounded-2xl hover:border-pink-500 transition">
                        <h3 className="text-xl font-semibold mb-3 text-pink-400">Premium Quality</h3>
                        <p className="text-gray-400 text-lg">Only carefully curated high-quality products make it here.</p>
                    </div>
                </div>
            </section>

            <section className="py-20 text-center border-t border-slate-800">
                <h2 className="text-2xl md:text-4xl font-bold mb-6">Ready to Upgrade Your Experience?</h2>

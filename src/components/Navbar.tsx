        ...
        <nav className="fixed top-0 w-full bg-slate-950/50 backdrop-blur-md border-b border-slate-800 text-white z-50">
            <div className="w-full mx-auto px-6 h-18 flex items-center justify-between">
                <div className="md:hidden flex-1">
                    <button onClick={() => setIsMenuOpen(!isMenuOpen)} className="p-2 text-2xl focus:outline-none">
                        {isMenuOpen ? "✕" : "☰"}
                    </button>
                </div>

                <div className="flex-1 flex items-center justify-center md:justify-start">
                    <img src="images/Pickup.svg" alt="carticon" className="w-8 h-8 mr-2" />
                ...
                <div className="hidden md:flex flex-1 justify-center items-center gap-12 text-2xl">
                    ...
                    <Link to="/store" className="hover:text-blue-400 transition">
                        Store
                    </Link>
            ...
            >
                <div className="flex flex-col p-4 gap-4 text-center">
                    <Link onClick={() => setIsMenuOpen(false)} to="/" className="text-2xl hover:text-blue-400">
                        Home
                    </Link>
                    <Link onClick={() => setIsMenuOpen(false)} to="/store" className="text-2xl hover:text-blue-400">
                        Store
                    </Link>
                    <Link onClick={() => setIsMenuOpen(false)} to="/about" className="text-2xl hover:text-blue-400">
                        About
                    </Link>
                </div>
            </div>
